...
const BASE_POST: BuddyPost = {
  ...
  // Wish posts carry no title: one description is the whole copy.
  title: '',
  body: 'Looking for this small Tokyo stationery set — the cream version shown in the photo is ideal. A close match is also welcome.',
  price_cents: 3200,
  ...
  from_city: 'Tokyo',
  to_city: 'Berlin',
  accepted_country: null,
  accepted_city: 'Don Quijote, Shinjuku, Tokyo',
